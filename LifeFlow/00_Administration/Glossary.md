...
Документ содержит список терминов, используемых в проекте LifeFlow, их определения и контекст применения.
...
10. Специфические термины LifeFlow
...
**State Management**  
Архитектурный подход для управления состоянием (в LifeFlow — Riverpod).
